...
This application detects face(s) in any images, videos, or through livestreaming from your webcam using OpenCV's deep learning model. Additionally, this app allows you to add a privacy filter to all detected faces!</h3>
""", unsafe_allow_html=True)
